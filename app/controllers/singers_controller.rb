class SingersController < ApplicationController
  ...
  private
    ...
    def singer_params
      params.require(:singer).permit( :photo1_caption, :photo2_caption, :photo, :remove_photo, :image, :remove_image, :last_name, :first_name, :email, :voice, :joined, :left, :join_year, :left_year, :notes, {:concert_ids => []}, {:song_ids => []})
    end
