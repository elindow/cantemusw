...
class SingersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create singer" do
    assert_difference('Singer.count') do
      post singers_url, params: { singer: { email: @singer.email, firstName: @singer.firstName, joined: @singer.joined, lastName: @singer.lastName, left: @singer.left, voice: @singer.voice } }
    end
  ...
  test "should update singer" do
    patch singer_url(@singer), params: { singer: { email: @singer.email, firstName: @singer.firstName, joined: @singer.joined, lastName: @singer.lastName, left: @singer.left, voice: @singer.voice } }
