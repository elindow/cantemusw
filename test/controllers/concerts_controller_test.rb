...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { accompanist: @concert.accompanist, concertdate: @concert.concertdate, conductor: @concert.conductor, name: @concert.name, notes: @concert.notes, theme: @concert.theme, venue: @concert.venue } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { accompanist: @concert.accompanist, concertdate: @concert.concertdate, conductor: @concert.conductor, name: @concert.name, notes: @concert.notes, theme: @concert.theme, venue: @concert.venue } }
